    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }} edges={['bottom', 'left', 'right']}>
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: 28 }} showsVerticalScrollIndicator={false}>
        ...
        {onceTasks.length > 0 ? (
          ...
          >
            <View>
              <Text style={{ fontSize: 16, fontWeight: "700", color: theme.text }}>One-off task heatmap</Text>
              <Text style={{ color: theme.textSecondary, fontSize: 14, lineHeight: 20 }}>
                Shows how many one-off tasks were completed per day for this goal. This is separate from recurring consistency tracking.
              </Text>
            </View>
